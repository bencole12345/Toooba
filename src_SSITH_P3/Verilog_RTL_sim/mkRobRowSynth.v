...
// dependsOn_wrongSpec_tag        I     2
// correctSpeculation_mask        I     4
// EN_write_enq                   I     1
...
module mkRobRowSynth(CLK,
  ...
  input  [343 : 0] write_enq_x;
  input  EN_write_enq;
  output RDY_write_enq;

  // value method read_deq
  output [343 : 0] read_deq;
  output RDY_read_deq;
  ...
  reg [3 : 0] m_spec_bits_rl;
  wire [3 : 0] m_spec_bits_rl$D_IN;
  ...
  reg [11 : 0] CASE_m_csr_BITS_11_TO_0_1_m_csr_BITS_11_TO_0_2_ETC__q3,
	       CASE_write_enq_x_BITS_170_TO_159_1_write_enq_x_ETC__q8;
  reg [3 : 0] CASE_m_trap_rl_BITS_3_TO_0_0_m_trap_rl_BITS_3__ETC__q1,
	      ...
	      CASE_write_enq_x_BITS_155_TO_152_0_write_enq_x_ETC__q5,
	      CASE_write_enq_x_BITS_155_TO_152_0_write_enq_x_ETC__q6;
  reg [1 : 0] CASE_write_enq_x_BITS_87_TO_86_0_write_enq_x_B_ETC__q7;
  wire [235 : 0] m_rg_dst_data_90_CONCAT_m_csr_91_BIT_12_92_CON_ETC___d689;
  wire [158 : 0] m_claimed_phy_reg_84_CONCAT_m_trap_dummy2_0_re_ETC___d688;
  ...
  // value method dependsOn_wrongSpec
  assign dependsOn_wrongSpec = bs__h32995[dependsOn_wrongSpec_tag] ;
  ...
  assign m_ppc_vaddr_csrData_lat_3$wget =
	     { CASE_write_enq_x_BITS_87_TO_86_0_write_enq_x_B_ETC__q7,
	       write_enq_x[85:22] } ;
  ...
  // register m_claimed_phy_reg
  assign m_claimed_phy_reg$D_IN = write_enq_x[158] ;
  ...
  // register m_epochIncremented
  assign m_epochIncremented$D_IN = write_enq_x[4] ;
  ...
  // register m_iType
  assign m_iType$D_IN = write_enq_x[247:243] ;
  ...
  // register m_lsqTag
  assign m_lsqTag$D_IN = write_enq_x[14:11] ;
  ...
  // register m_orig_inst
  assign m_orig_inst$D_IN = write_enq_x[279:248] ;
  assign m_orig_inst$EN = EN_write_enq ;

  // register m_pc
  assign m_pc$D_IN = write_enq_x[343:280] ;
  ...
  // register m_rg_dst_reg
  assign m_rg_dst_reg$D_IN = write_enq_x[242:236] ;
  ...
  // register m_tval_rl
  assign m_tval_rl$D_IN = EN_write_enq ? write_enq_x[151:88] : m_tval_rl ;
  assign m_tval_rl$EN = 1'd1 ;

  // register m_will_dirty_fpu_state
  assign m_will_dirty_fpu_state$D_IN = write_enq_x[16] ;
  ...
  assign IF_m_spec_bits_lat_1_whas__93_THEN_m_spec_bits_ETC___d299 =
	     EN_write_enq ? write_enq_x[3:0] : m_spec_bits_rl ;
  ...
  assign sb__h33030 =
	     m_spec_bits_dummy2_2$Q_OUT ?
	       IF_m_spec_bits_lat_1_whas__93_THEN_m_spec_bits_ETC___d299 :
	       4'd0 ;
  assign upd__h17975 = sb__h33030 & correctSpeculation_mask ;
  assign x__h26957 =
	     (m_tval_dummy2_0$Q_OUT && m_tval_dummy2_1$Q_OUT &&
	      m_tval_dummy2_2$Q_OUT) ?
	       m_tval_rl :
	       64'd0 ;
  assign x_read_deq_fflags__h25972 =
  ...
  always@(write_enq_x)
  begin
    case (write_enq_x[155:152])
      4'd0, 4'd1, 4'd3, 4'd4, 4'd5, 4'd7, 4'd8, 4'd9, 4'd11, 4'd14:
	  CASE_write_enq_x_BITS_155_TO_152_0_write_enq_x_ETC__q5 =
	      write_enq_x[155:152];
      default: CASE_write_enq_x_BITS_155_TO_152_0_write_enq_x_ETC__q5 = 4'd15;
    endcase
  end
  always@(write_enq_x)
  begin
    case (write_enq_x[155:152])
	  ...
	  CASE_write_enq_x_BITS_155_TO_152_0_write_enq_x_ETC__q6 =
	      write_enq_x[155:152];
      default: CASE_write_enq_x_BITS_155_TO_152_0_write_enq_x_ETC__q6 = 4'd15;
    endcase
  end
  always@(write_enq_x)
  begin
    case (write_enq_x[87:86])
      2'd0, 2'd1:
	  CASE_write_enq_x_BITS_87_TO_86_0_write_enq_x_B_ETC__q7 =
	      write_enq_x[87:86];
      default: CASE_write_enq_x_BITS_87_TO_86_0_write_enq_x_B_ETC__q7 = 2'd2;
    endcase
  end
  always@(write_enq_x)
  begin
    case (write_enq_x[170:159])
      12'd1,
      12'd2,
      12'd3,
      12'd256,
	  ...
	  CASE_write_enq_x_BITS_170_TO_159_1_write_enq_x_ETC__q8 =
	      write_enq_x[170:159];
      default: CASE_write_enq_x_BITS_170_TO_159_1_write_enq_x_ETC__q8 =
		   12'd2303;
    endcase
  end
  ...
  begin
	...
	m_spec_bits_rl <= `BSV_ASSIGNMENT_DELAY 4'hA;
  ...
  begin
	...
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_enq && write_enq_x[10])
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_enq && write_enq_x[7])
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_enq && write_enq_x[6])
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_enq && write_enq_x[5])
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
  end
  // synopsys translate_on
