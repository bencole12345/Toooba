...
module mkMemDispToRegFifo(CLK,
  ...
  wire [3 : 0] IF_m_m_specBits_0_dummy2_0_read__3_AND_m_m_spe_ETC___d66,
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h6944 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN = enq_x[85:4] ;
  ...
  initial
  begin
    m_m_row_0 = 82'h2AAAAAAAAAAAAAAAAAAAA;
