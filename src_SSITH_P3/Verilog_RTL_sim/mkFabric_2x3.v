...
module mkFabric_2x3(CLK,
  ...
  reg CASE_fabric_v_f_wd_tasks_0D_OUT_BITS_9_TO_8_0_ETC__q2,
      CASE_fabric_v_f_wd_tasks_1D_OUT_BITS_9_TO_8_0_ETC__q1;
  wire [7 : 0] x__h11903,
	       x__h12346,
	       x__h18100,
	       x__h18726,
  ...
  wire [1 : 0] IF_fabric_v_rg_r_beat_count_0_67_EQ_fabric_v_f_ETC___d396,
	       ...
	       x1_avValue_rresp__h18078,
	       x1_avValue_rresp__h18704,
	       x1_avValue_rresp__h19320;
  ...
  assign fabric_v_f_wd_tasks_0_i_notEmpty__21_AND_fabri_ETC___d130 =
	     fabric_v_f_wd_tasks_0$EMPTY_N &&
	     CASE_fabric_v_f_wd_tasks_0D_OUT_BITS_9_TO_8_0_ETC__q2 ;
  ...
  assign soc_map_m_plic_addr_base__2_ULE_fabric_xactors_ETC___d86 =
	     soc_map$m_plic_addr_base <=
	     fabric_xactors_from_masters_1_f_wr_addr$D_OUT[92:29] ;
  assign x1_avValue_rresp__h18078 =
	     (fabric_xactors_to_slaves_0_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_0_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_0_f_rd_data$D_OUT[2:1] ;
  assign x1_avValue_rresp__h18704 =
	     (fabric_xactors_to_slaves_1_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_1_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_1_f_rd_data$D_OUT[2:1] ;
  assign x1_avValue_rresp__h19320 =
	     (fabric_xactors_to_slaves_2_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_2_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_2_f_rd_data$D_OUT[2:1] ;
  assign x__h11903 = fabric_v_rg_wd_beat_count_0 + 8'd1 ;
  assign x__h12346 = fabric_v_rg_wd_beat_count_1 + 8'd1 ;
  assign x__h18100 = fabric_v_rg_r_beat_count_0 + 8'd1 ;
  assign x__h18726 = fabric_v_rg_r_beat_count_1 + 8'd1 ;
  assign x__h19342 = fabric_v_rg_r_beat_count_2 + 8'd1 ;
  assign x__h21646 = fabric_v_rg_r_err_beat_count_0 + 8'd1 ;
  assign x__h22047 = fabric_v_rg_r_err_beat_count_1 + 8'd1 ;
  ...
  begin
    case (fabric_v_f_wd_tasks_1$D_OUT[9:8])
	  ...
	  CASE_fabric_v_f_wd_tasks_1D_OUT_BITS_9_TO_8_0_ETC__q1 =
	      fabric_xactors_to_slaves_2_f_wr_data$FULL_N;
      2'd3: CASE_fabric_v_f_wd_tasks_1D_OUT_BITS_9_TO_8_0_ETC__q1 = 1'd1;
    endcase
  end
  ...
  begin
    case (fabric_v_f_wd_tasks_0$D_OUT[9:8])
	  ...
	  CASE_fabric_v_f_wd_tasks_0D_OUT_BITS_9_TO_8_0_ETC__q2 =
	      fabric_xactors_to_slaves_2_f_wr_data$FULL_N;
      2'd3: CASE_fabric_v_f_wd_tasks_0D_OUT_BITS_9_TO_8_0_ETC__q2 = 1'd1;
    endcase
  end
  ...
  begin
    ...
    v__h5835 = v__h5841 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (fabric_rg_reset) $display("%0d: %m.rl_reset", v__h5835);
  end
  // synopsys translate_on
