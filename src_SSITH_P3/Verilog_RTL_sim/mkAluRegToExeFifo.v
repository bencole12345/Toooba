...
module mkAluRegToExeFifo(CLK,
  ...
  reg [20 : 0] CASE_enq_x_BITS_404_TO_402_0_enq_x_BITS_404_TO_ETC__q2,
	       CASE_m_m_row_0_BITS_400_TO_398_0_m_m_row_0_BIT_ETC__q5;
  reg [11 : 0] CASE_enq_x_BITS_382_TO_371_1_enq_x_BITS_382_TO_ETC__q3,
	       CASE_m_m_row_0_BITS_378_TO_367_1_m_m_row_0_BIT_ETC__q6;
  reg [2 : 0] CASE_enq_x_BITS_387_TO_385_0_enq_x_BITS_387_TO_ETC__q1,
	      CASE_m_m_row_0_BITS_383_TO_381_0_m_m_row_0_BIT_ETC__q4;
  wire [3 : 0] IF_m_m_specBits_0_dummy2_0_read__94_AND_m_m_sp_ETC___d297,
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h10351 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN =
	     { enq_x[409:405],
	       CASE_enq_x_BITS_404_TO_402_0_enq_x_BITS_404_TO_ETC__q2,
	       enq_x[383],
	       CASE_enq_x_BITS_382_TO_371_1_enq_x_BITS_382_TO_ETC__q3,
	       enq_x[370:4] } ;
  ...
  begin
    case (enq_x[387:385])
	  ...
	  CASE_enq_x_BITS_387_TO_385_0_enq_x_BITS_387_TO_ETC__q1 =
	      enq_x[387:385];
      default: CASE_enq_x_BITS_387_TO_385_0_enq_x_BITS_387_TO_ETC__q1 = 3'd7;
    endcase
  end
  always@(enq_x or CASE_enq_x_BITS_387_TO_385_0_enq_x_BITS_387_TO_ETC__q1)
  begin
    case (enq_x[404:402])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_enq_x_BITS_404_TO_402_0_enq_x_BITS_404_TO_ETC__q2 =
	  ...
	  CASE_enq_x_BITS_404_TO_402_0_enq_x_BITS_404_TO_ETC__q2 =
		...
		CASE_enq_x_BITS_387_TO_385_0_enq_x_BITS_387_TO_ETC__q1,
		enq_x[384] };
      default: CASE_enq_x_BITS_404_TO_402_0_enq_x_BITS_404_TO_ETC__q2 =
		   21'd1485482;
    endcase
  end
  always@(enq_x)
  begin
    case (enq_x[382:371])
	  ...
	  CASE_enq_x_BITS_382_TO_371_1_enq_x_BITS_382_TO_ETC__q3 =
	      enq_x[382:371];
      default: CASE_enq_x_BITS_382_TO_371_1_enq_x_BITS_382_TO_ETC__q3 =
		   12'd2303;
    endcase
  end
  always@(m_m_row_0)
  begin
    case (m_m_row_0[383:381])
      3'd0, 3'd1, 3'd2, 3'd3, 3'd4:
	  CASE_m_m_row_0_BITS_383_TO_381_0_m_m_row_0_BIT_ETC__q4 =
	      m_m_row_0[383:381];
      default: CASE_m_m_row_0_BITS_383_TO_381_0_m_m_row_0_BIT_ETC__q4 = 3'd7;
    endcase
  end
  always@(m_m_row_0 or CASE_m_m_row_0_BITS_383_TO_381_0_m_m_row_0_BIT_ETC__q4)
  begin
    case (m_m_row_0[400:398])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_m_m_row_0_BITS_400_TO_398_0_m_m_row_0_BIT_ETC__q5 =
	      m_m_row_0[400:380];
      3'd4:
	  CASE_m_m_row_0_BITS_400_TO_398_0_m_m_row_0_BIT_ETC__q5 =
		...
		CASE_m_m_row_0_BITS_383_TO_381_0_m_m_row_0_BIT_ETC__q4,
		m_m_row_0[380] };
      default: CASE_m_m_row_0_BITS_400_TO_398_0_m_m_row_0_BIT_ETC__q5 =
		   21'd1485482;
    endcase
  end
  always@(m_m_row_0)
  begin
    case (m_m_row_0[378:367])
      12'd1,
      12'd2,
      12'd3,
      12'd256,
	  ...
	  CASE_m_m_row_0_BITS_378_TO_367_1_m_m_row_0_BIT_ETC__q6 =
	      m_m_row_0[378:367];
      default: CASE_m_m_row_0_BITS_378_TO_367_1_m_m_row_0_BIT_ETC__q6 =
		   12'd2303;
    endcase
  end
  ...
  begin
    m_m_row_0 =
	406'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
