...
module mkAluDispToRegFifo(CLK,
  ...
  reg [20 : 0] CASE_enq_x_BITS_140_TO_138_0_enq_x_BITS_140_TO_ETC__q2,
	       CASE_m_m_row_0_BITS_136_TO_134_0_m_m_row_0_BIT_ETC__q5;
  reg [11 : 0] CASE_enq_x_BITS_118_TO_107_1_enq_x_BITS_118_TO_ETC__q3,
	       CASE_m_m_row_0_BITS_114_TO_103_1_m_m_row_0_BIT_ETC__q6;
  reg [2 : 0] CASE_enq_x_BITS_123_TO_121_0_enq_x_BITS_123_TO_ETC__q1,
	      CASE_m_m_row_0_BITS_119_TO_117_0_m_m_row_0_BIT_ETC__q4;
  wire [3 : 0] IF_m_m_specBits_0_dummy2_0_read__18_AND_m_m_sp_ETC___d321,
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h10714 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN =
	     { enq_x[145:141],
	       CASE_enq_x_BITS_140_TO_138_0_enq_x_BITS_140_TO_ETC__q2,
	       enq_x[119],
	       CASE_enq_x_BITS_118_TO_107_1_enq_x_BITS_118_TO_ETC__q3,
	       enq_x[106:4] } ;
  ...
  begin
    case (enq_x[123:121])
	  ...
	  CASE_enq_x_BITS_123_TO_121_0_enq_x_BITS_123_TO_ETC__q1 =
	      enq_x[123:121];
      default: CASE_enq_x_BITS_123_TO_121_0_enq_x_BITS_123_TO_ETC__q1 = 3'd7;
    endcase
  end
  always@(enq_x or CASE_enq_x_BITS_123_TO_121_0_enq_x_BITS_123_TO_ETC__q1)
  begin
    case (enq_x[140:138])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_enq_x_BITS_140_TO_138_0_enq_x_BITS_140_TO_ETC__q2 =
	  ...
	  CASE_enq_x_BITS_140_TO_138_0_enq_x_BITS_140_TO_ETC__q2 =
		...
		CASE_enq_x_BITS_123_TO_121_0_enq_x_BITS_123_TO_ETC__q1,
		enq_x[120] };
      default: CASE_enq_x_BITS_140_TO_138_0_enq_x_BITS_140_TO_ETC__q2 =
		   21'd1485482;
    endcase
  end
  always@(enq_x)
  begin
    case (enq_x[118:107])
	  ...
	  CASE_enq_x_BITS_118_TO_107_1_enq_x_BITS_118_TO_ETC__q3 =
	      enq_x[118:107];
      default: CASE_enq_x_BITS_118_TO_107_1_enq_x_BITS_118_TO_ETC__q3 =
		   12'd2303;
    endcase
  end
  always@(m_m_row_0)
  begin
    case (m_m_row_0[119:117])
      3'd0, 3'd1, 3'd2, 3'd3, 3'd4:
	  CASE_m_m_row_0_BITS_119_TO_117_0_m_m_row_0_BIT_ETC__q4 =
	      m_m_row_0[119:117];
      default: CASE_m_m_row_0_BITS_119_TO_117_0_m_m_row_0_BIT_ETC__q4 = 3'd7;
    endcase
  end
  always@(m_m_row_0 or CASE_m_m_row_0_BITS_119_TO_117_0_m_m_row_0_BIT_ETC__q4)
  begin
    case (m_m_row_0[136:134])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_m_m_row_0_BITS_136_TO_134_0_m_m_row_0_BIT_ETC__q5 =
	      m_m_row_0[136:116];
      3'd4:
	  CASE_m_m_row_0_BITS_136_TO_134_0_m_m_row_0_BIT_ETC__q5 =
		...
		CASE_m_m_row_0_BITS_119_TO_117_0_m_m_row_0_BIT_ETC__q4,
		m_m_row_0[116] };
      default: CASE_m_m_row_0_BITS_136_TO_134_0_m_m_row_0_BIT_ETC__q5 =
		   21'd1485482;
    endcase
  end
  always@(m_m_row_0)
  begin
    case (m_m_row_0[114:103])
      12'd1,
      12'd2,
      12'd3,
      12'd256,
	  ...
	  CASE_m_m_row_0_BITS_114_TO_103_1_m_m_row_0_BIT_ETC__q6 =
	      m_m_row_0[114:103];
      default: CASE_m_m_row_0_BITS_114_TO_103_1_m_m_row_0_BIT_ETC__q6 =
		   12'd2303;
    endcase
  end
  ...
  initial
  begin
    m_m_row_0 = 142'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
