...
// stuck_get                      O   157 const
// RDY_stuck_get                  O     1 const
// CLK                            I     1 clock
// RST_N                          I     1 reset
// cRqTransfer_getRq_n            I     3
// cRqTransfer_getEmptyEntryInit_r  I   151
...
module mkDCRqMshrWrapper(CLK,
  ...
  output [150 : 0] sendRsToP_cRq_getRq;
  ...
  reg [150 : 0] m_m_reqVec_0_rl;
  wire [150 : 0] m_m_reqVec_0_rl$D_IN;
  wire m_m_reqVec_0_rl$EN;

  // register m_m_reqVec_1_rl
  reg [150 : 0] m_m_reqVec_1_rl;
  wire [150 : 0] m_m_reqVec_1_rl$D_IN;
  wire m_m_reqVec_1_rl$EN;

  // register m_m_reqVec_2_rl
  reg [150 : 0] m_m_reqVec_2_rl;
  wire [150 : 0] m_m_reqVec_2_rl$D_IN;
  wire m_m_reqVec_2_rl$EN;

  // register m_m_reqVec_3_rl
  reg [150 : 0] m_m_reqVec_3_rl;
  wire [150 : 0] m_m_reqVec_3_rl$D_IN;
  wire m_m_reqVec_3_rl$EN;

  // register m_m_reqVec_4_rl
  reg [150 : 0] m_m_reqVec_4_rl;
  wire [150 : 0] m_m_reqVec_4_rl$D_IN;
  wire m_m_reqVec_4_rl$EN;

  // register m_m_reqVec_5_rl
  reg [150 : 0] m_m_reqVec_5_rl;
  wire [150 : 0] m_m_reqVec_5_rl$D_IN;
  wire m_m_reqVec_5_rl$EN;

  // register m_m_reqVec_6_rl
  reg [150 : 0] m_m_reqVec_6_rl;
  wire [150 : 0] m_m_reqVec_6_rl$D_IN;
  wire m_m_reqVec_6_rl$EN;

  // register m_m_reqVec_7_rl
  reg [150 : 0] m_m_reqVec_7_rl;
  wire [150 : 0] m_m_reqVec_7_rl$D_IN;
  ...
  // actionvalue method stuck_get
  assign stuck_get = 157'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA ;
  ...
  assign n__read_id__h122164 =
	     (m_m_reqVec_0_dummy2_0$Q_OUT && m_m_reqVec_0_dummy2_1$Q_OUT &&
	      m_m_reqVec_0_dummy2_2$Q_OUT) ?
	       m_m_reqVec_0_rl[150:148] :
	       3'd0 ;
  assign n__read_id__h122255 =
	     (m_m_reqVec_1_dummy2_0$Q_OUT && m_m_reqVec_1_dummy2_1$Q_OUT &&
	      m_m_reqVec_1_dummy2_2$Q_OUT) ?
	       m_m_reqVec_1_rl[150:148] :
	       3'd0 ;
  assign n__read_id__h122346 =
	     (m_m_reqVec_2_dummy2_0$Q_OUT && m_m_reqVec_2_dummy2_1$Q_OUT &&
	      m_m_reqVec_2_dummy2_2$Q_OUT) ?
	       m_m_reqVec_2_rl[150:148] :
	       3'd0 ;
  assign n__read_id__h122437 =
	     (m_m_reqVec_3_dummy2_0$Q_OUT && m_m_reqVec_3_dummy2_1$Q_OUT &&
	      m_m_reqVec_3_dummy2_2$Q_OUT) ?
	       m_m_reqVec_3_rl[150:148] :
	       3'd0 ;
  assign n__read_id__h122528 =
	     (m_m_reqVec_4_dummy2_0$Q_OUT && m_m_reqVec_4_dummy2_1$Q_OUT &&
	      m_m_reqVec_4_dummy2_2$Q_OUT) ?
	       m_m_reqVec_4_rl[150:148] :
	       3'd0 ;
  assign n__read_id__h122619 =
	     (m_m_reqVec_5_dummy2_0$Q_OUT && m_m_reqVec_5_dummy2_1$Q_OUT &&
	      m_m_reqVec_5_dummy2_2$Q_OUT) ?
	       m_m_reqVec_5_rl[150:148] :
	       3'd0 ;
  assign n__read_id__h122710 =
	     (m_m_reqVec_6_dummy2_0$Q_OUT && m_m_reqVec_6_dummy2_1$Q_OUT &&
	      m_m_reqVec_6_dummy2_2$Q_OUT) ?
	       m_m_reqVec_6_rl[150:148] :
	       3'd0 ;
  assign n__read_id__h122801 =
	     (m_m_reqVec_7_dummy2_0$Q_OUT && m_m_reqVec_7_dummy2_1$Q_OUT &&
	      m_m_reqVec_7_dummy2_2$Q_OUT) ?
	       m_m_reqVec_7_rl[150:148] :
	       3'd0 ;
  ...
  assign n__read_id__h86243 =
	     m_m_reqVec_0_dummy2_2$Q_OUT ? m_m_reqVec_0_rl[150:148] : 3'd0 ;
  assign n__read_id__h86465 =
	     m_m_reqVec_1_dummy2_2$Q_OUT ? m_m_reqVec_1_rl[150:148] : 3'd0 ;
  assign n__read_id__h86687 =
	     m_m_reqVec_2_dummy2_2$Q_OUT ? m_m_reqVec_2_rl[150:148] : 3'd0 ;
  assign n__read_id__h86909 =
	     m_m_reqVec_3_dummy2_2$Q_OUT ? m_m_reqVec_3_rl[150:148] : 3'd0 ;
  assign n__read_id__h87131 =
	     m_m_reqVec_4_dummy2_2$Q_OUT ? m_m_reqVec_4_rl[150:148] : 3'd0 ;
  assign n__read_id__h87353 =
	     m_m_reqVec_5_dummy2_2$Q_OUT ? m_m_reqVec_5_rl[150:148] : 3'd0 ;
  assign n__read_id__h87575 =
	     m_m_reqVec_6_dummy2_2$Q_OUT ? m_m_reqVec_6_rl[150:148] : 3'd0 ;
  assign n__read_id__h87797 =
	     m_m_reqVec_7_dummy2_2$Q_OUT ? m_m_reqVec_7_rl[150:148] : 3'd0 ;
  ...
  begin
    ...
    m_m_initIdx = 3'h2;
    m_m_inited = 1'h0;
    m_m_reqVec_0_rl = 151'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    m_m_reqVec_1_rl = 151'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    m_m_reqVec_2_rl = 151'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    m_m_reqVec_3_rl = 151'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    m_m_reqVec_4_rl = 151'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    m_m_reqVec_5_rl = 151'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    m_m_reqVec_6_rl = 151'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    m_m_reqVec_7_rl = 151'h2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
