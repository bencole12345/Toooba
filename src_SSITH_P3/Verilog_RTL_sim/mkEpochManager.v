...
// getEpochState                  O     4 reg
// RDY_getEpochState              O     1 const
// isFull_ehrPort0                O     1
// RDY_isFull_ehrPort0            O     1 const
// CLK                            I     1 clock
// RST_N                          I     1 reset
// checkEpoch_0_check_e           I     2
// checkEpoch_1_check_e           I     2
// updatePrevEpoch_0_update_e     I     2
// updatePrevEpoch_1_update_e     I     2
...
module mkEpochManager(CLK,
  ...
  // inlined wires
  wire [2 : 0] updatePrevEn_0_lat_0$wget, updatePrevEn_1_lat_0$wget;

  // register curr_epoch
  reg [1 : 0] curr_epoch;
  wire [1 : 0] curr_epoch$D_IN;
  wire curr_epoch$EN;

  // register prev_checked_epoch
  reg [1 : 0] prev_checked_epoch;
  wire [1 : 0] prev_checked_epoch$D_IN;
  wire prev_checked_epoch$EN;

  // register updatePrevEn_0_rl
  reg [2 : 0] updatePrevEn_0_rl;
  wire [2 : 0] updatePrevEn_0_rl$D_IN;
  wire updatePrevEn_0_rl$EN;

  // register updatePrevEn_1_rl
  reg [2 : 0] updatePrevEn_1_rl;
  wire [2 : 0] updatePrevEn_1_rl$D_IN;
  ...
  wire [1 : 0] IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d19,
	       _theResult____h5017,
	       next_epoch__h81;
  ...
  assign prev_checked_epoch$D_IN =
	     NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_up_ETC___d47 ?
	       ...
	       (EN_updatePrevEpoch_1_update ?
		  updatePrevEn_1_lat_0$wget[1:0] :
		  updatePrevEn_1_rl[1:0]) ;
  assign prev_checked_epoch$EN =
	     IF_NOT_updatePrevEn_1_dummy2_1_read__5_6_OR_IF_ETC___d50 ;

  // register updatePrevEn_0_rl
  assign updatePrevEn_0_rl$D_IN = 3'b010 ;
  assign updatePrevEn_0_rl$EN = 1'd1 ;

  // register updatePrevEn_1_rl
  assign updatePrevEn_1_rl$D_IN = 3'b010 ;
  ...
  assign IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d19 =
	     EN_updatePrevEpoch_0_update ?
	       updatePrevEn_0_lat_0$wget[1:0] :
	       updatePrevEn_0_rl[1:0] ;
  assign IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d9 =
	     EN_updatePrevEpoch_0_update ?
	       updatePrevEn_0_lat_0$wget[2] :
	       updatePrevEn_0_rl[2] ;
  ...
  assign _theResult____h5017 =
	     (updatePrevEn_0_dummy2_1$Q_OUT &&
	      IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d9) ?
	       IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d19 :
	       prev_checked_epoch ;
  assign next_epoch__h81 = (curr_epoch == 2'd3) ? 2'd0 : curr_epoch + 2'd1 ;
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        curr_epoch <= `BSV_ASSIGNMENT_DELAY 2'd0;
	prev_checked_epoch <= `BSV_ASSIGNMENT_DELAY 2'd0;
	updatePrevEn_0_rl <= `BSV_ASSIGNMENT_DELAY 3'd2;
	updatePrevEn_1_rl <= `BSV_ASSIGNMENT_DELAY 3'd2;
      end
    else
      begin
        if (curr_epoch$EN)
  ...
  begin
    curr_epoch = 2'h2;
    prev_checked_epoch = 2'h2;
    updatePrevEn_0_rl = 3'h2;
    updatePrevEn_1_rl = 3'h2;
  end
