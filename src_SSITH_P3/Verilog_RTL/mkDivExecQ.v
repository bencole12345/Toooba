...
module mkDivExecQ(CLK,
  ...
  wire [3 : 0] m_specBits_0_lat_1$wget, m_specBits_1_lat_1$wget;
  ...
  // register m_row_0
  reg [21 : 0] m_row_0;
  wire [21 : 0] m_row_0$D_IN;
  wire m_row_0$EN;

  // register m_row_1
  reg [21 : 0] m_row_1;
  wire [21 : 0] m_row_1$D_IN;
  wire m_row_1$EN;

  // register m_specBits_0_rl
  reg [3 : 0] m_specBits_0_rl;
  wire [3 : 0] m_specBits_0_rl$D_IN;
  wire m_specBits_0_rl$EN;

  // register m_specBits_1_rl
  reg [3 : 0] m_specBits_1_rl;
  wire [3 : 0] m_specBits_1_rl$D_IN;
  ...
  reg [6 : 0] CASE_m_deqP_0_m_row_0_BITS_17_TO_11_1_m_row_1__ETC__q5;
  reg [4 : 0] CASE_m_deqP_0_m_row_0_BITS_4_TO_0_1_m_row_1_BI_ETC__q3;
  reg [3 : 0] CASE_m_deqP_0_bs0338_1_bs0570_DONTCARE__q9,
	      CASE_m_deqP_0_m_row_0_BITS_8_TO_5_1_m_row_1_BI_ETC__q2;
  reg [1 : 0] CASE_m_deqP_0_m_row_0_BITS_21_TO_20_1_m_row_1__ETC__q8;
  reg CASE_m_deqP_0_NOT_m_row_0_BIT_18_1_NOT_m_row_1_ETC__q4,
      CASE_m_deqP_0_m_row_0_BIT_10_1_m_row_1_BIT_10__ETC__q6,
      CASE_m_deqP_0_m_row_0_BIT_19_1_m_row_1_BIT_19__ETC__q7,
      CASE_m_deqP_0_m_row_0_BIT_9_1_m_row_1_BIT_9_DO_ETC__q1;
  wire [19 : 0] SEL_ARR_m_row_0_5_BIT_19_1_m_row_1_7_BIT_19_2__ETC___d116;
  wire [9 : 0] SEL_ARR_m_row_0_5_BIT_9_03_m_row_1_7_BIT_9_04__ETC___d115;
  wire [8 : 0] NOT_SEL_ARR_NOT_m_row_0_5_BIT_18_5_6_NOT_m_row_ETC___d102;
  wire [3 : 0] IF_m_specBits_0_lat_0_whas__1_THEN_m_specBits__ETC___d34,
  ...
  // value method first_data
  assign first_data =
	     { CASE_m_deqP_0_m_row_0_BITS_21_TO_20_1_m_row_1__ETC__q8,
	       SEL_ARR_m_row_0_5_BIT_19_1_m_row_1_7_BIT_19_2__ETC___d116,
	       CASE_m_deqP_0_bs0338_1_bs0570_DONTCARE__q9 } ;
  ...
  assign m_poisoned_0_lat_0$whas =
	     EN_specUpdate_incorrectSpeculation &&
	     (specUpdate_incorrectSpeculation_kill_all ||
	      bs__h10338[specUpdate_incorrectSpeculation_kill_tag]) ;
  assign m_poisoned_1_lat_0$whas =
	     EN_specUpdate_incorrectSpeculation &&
	     (specUpdate_incorrectSpeculation_kill_all ||
	      bs__h10570[specUpdate_incorrectSpeculation_kill_tag]) ;
  assign m_specBits_0_lat_1$wget =
	     n__read__h10860 & specUpdate_correctSpeculation_mask ;
  assign m_specBits_1_lat_1$wget =
	     n__read__h11301 & specUpdate_correctSpeculation_mask ;
  always@(m_enqP or
	  m_valid_0_dummy2_0$Q_OUT or
	  m_valid_0_dummy2_1$Q_OUT or
	  m_valid_0_rl or
  ...
  // register m_row_0
  assign m_row_0$D_IN = enq_x[25:4] ;
  assign m_row_0$EN = m_valid_0_lat_1$whas ;

  // register m_row_1
  assign m_row_1$D_IN = enq_x[25:4] ;
  ...
  assign IF_m_specBits_0_lat_0_whas__1_THEN_m_specBits__ETC___d34 =
	     m_valid_0_lat_1$whas ? enq_x[3:0] : m_specBits_0_rl ;
  assign IF_m_specBits_1_lat_0_whas__8_THEN_m_specBits__ETC___d41 =
	     m_valid_1_lat_1$whas ? enq_x[3:0] : m_specBits_1_rl ;
  assign NOT_SEL_ARR_NOT_m_row_0_5_BIT_18_5_6_NOT_m_row_ETC___d102 =
	     { !CASE_m_deqP_0_NOT_m_row_0_BIT_18_1_NOT_m_row_1_ETC__q4,
	       CASE_m_deqP_0_m_row_0_BITS_17_TO_11_1_m_row_1__ETC__q5,
	       CASE_m_deqP_0_m_row_0_BIT_10_1_m_row_1_BIT_10__ETC__q6 } ;
  assign SEL_ARR_m_row_0_5_BIT_19_1_m_row_1_7_BIT_19_2__ETC___d116 =
	     { CASE_m_deqP_0_m_row_0_BIT_19_1_m_row_1_BIT_19__ETC__q7,
	       NOT_SEL_ARR_NOT_m_row_0_5_BIT_18_5_6_NOT_m_row_ETC___d102,
	       SEL_ARR_m_row_0_5_BIT_9_03_m_row_1_7_BIT_9_04__ETC___d115 } ;
  assign SEL_ARR_m_row_0_5_BIT_9_03_m_row_1_7_BIT_9_04__ETC___d115 =
	     { CASE_m_deqP_0_m_row_0_BIT_9_1_m_row_1_BIT_9_DO_ETC__q1,
	       CASE_m_deqP_0_m_row_0_BITS_8_TO_5_1_m_row_1_BI_ETC__q2,
	       CASE_m_deqP_0_m_row_0_BITS_4_TO_0_1_m_row_1_BI_ETC__q3 } ;
  assign bs__h10338 =
  ...
  assign bs__h10570 =
	     (m_specBits_1_dummy2_0$Q_OUT && m_specBits_1_dummy2_1$Q_OUT) ?
	       m_specBits_1_rl :
	       4'd0 ;
  assign n__read__h10860 =
	     m_specBits_0_dummy2_1$Q_OUT ?
	       IF_m_specBits_0_lat_0_whas__1_THEN_m_specBits__ETC___d34 :
	       4'd0 ;
  assign n__read__h11301 =
	     m_specBits_1_dummy2_1$Q_OUT ?
	       IF_m_specBits_1_lat_0_whas__8_THEN_m_specBits__ETC___d41 :
	       4'd0 ;
  assign upd__h5429 = m_specBits_0_lat_1$wget ;
  assign upd__h6358 = m_specBits_1_lat_1$wget ;
  always@(m_deqP or m_row_0 or m_row_1)
  begin
    case (m_deqP)
      1'd0:
	  CASE_m_deqP_0_m_row_0_BIT_9_1_m_row_1_BIT_9_DO_ETC__q1 = m_row_0[9];
      1'd1:
	  CASE_m_deqP_0_m_row_0_BIT_9_1_m_row_1_BIT_9_DO_ETC__q1 = m_row_1[9];
    endcase
  end
  always@(m_deqP or m_row_0 or m_row_1)
  begin
  ...
  always@(m_deqP or bs__h10338 or bs__h10570)
  begin
    case (m_deqP)
      1'd0: CASE_m_deqP_0_bs0338_1_bs0570_DONTCARE__q9 = bs__h10338;
      1'd1: CASE_m_deqP_0_bs0338_1_bs0570_DONTCARE__q9 = bs__h10570;
    endcase
  end
  ...
  begin
	...
	m_specBits_0_rl <= `BSV_ASSIGNMENT_DELAY 4'hA;
	m_specBits_1_rl <= `BSV_ASSIGNMENT_DELAY 4'hA;
  ...
  begin
    ...
    m_row_0 = 22'h2AAAAA;
    m_row_1 = 22'h2AAAAA;
    m_specBits_0_rl = 4'hA;
    m_specBits_1_rl = 4'hA;
    m_valid_0_rl = 1'h0;
    m_valid_1_rl = 1'h0;
  end
