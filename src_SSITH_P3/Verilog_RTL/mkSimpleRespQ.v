...
module mkSimpleRespQ(CLK,
  ...
  // register m_m_row_0
  reg [87 : 0] m_m_row_0;
  wire [87 : 0] m_m_row_0$D_IN;
  wire m_m_row_0$EN;

  // register m_m_row_1
  reg [87 : 0] m_m_row_1;
  wire [87 : 0] m_m_row_1$D_IN;
  wire m_m_row_1$EN;
  ...
  reg [63 : 0] CASE_p524_0_m_m_row_0_BITS_87_TO_24_1_m_m_row__ETC__q7;
  reg [6 : 0] CASE_p524_0_m_m_row_0_BITS_17_TO_11_1_m_m_row__ETC__q2;
  reg [4 : 0] CASE_p524_0_m_m_row_0_BITS_23_TO_19_1_m_m_row__ETC__q8,
	      CASE_p524_0_m_m_row_0_BITS_4_TO_0_1_m_m_row_1__ETC__q6;
  reg [3 : 0] CASE_p524_0_m_m_row_0_BITS_8_TO_5_1_m_m_row_1__ETC__q5,
	      CASE_p524_0_sb527_1_sb705_DONTCARE__q9;
  reg CASE_p524_0_NOT_m_m_row_0_BIT_18_1_NOT_m_m_row_ETC__q1,
      CASE_p524_0_m_m_row_0_BIT_10_1_m_m_row_1_BIT_1_ETC__q3,
      CASE_p524_0_m_m_row_0_BIT_9_1_m_m_row_1_BIT_9__ETC__q4,
      SEL_ARR_NOT_m_m_valid_0_dummy2_0_read__6_7_OR__ETC___d55;
  wire [18 : 0] NOT_SEL_ARR_NOT_m_m_row_0_4_BIT_18_05_06_NOT_m_ETC___d135;
  wire [3 : 0] IF_m_m_specBits_0_lat_0_whas__7_THEN_m_m_specB_ETC___d20,
  ...
  // action method enq
  assign RDY_enq =
	     m_m_empty_for_enq_wire$wget || m_m_enqP != x_snd_fst__h7135 ;
  assign CAN_FIRE_enq =
	     m_m_empty_for_enq_wire$wget || m_m_enqP != x_snd_fst__h7135 ;
  ...
  // value method first
  assign first =
	     { CASE_p524_0_m_m_row_0_BITS_87_TO_24_1_m_m_row__ETC__q7,
	       CASE_p524_0_m_m_row_0_BITS_23_TO_19_1_m_m_row__ETC__q8,
	       NOT_SEL_ARR_NOT_m_m_row_0_4_BIT_18_05_06_NOT_m_ETC___d135,
	       CASE_p524_0_sb527_1_sb705_DONTCARE__q9 } ;
  ...
  assign MUX_m_m_valid_0_dummy2_0$write_1__SEL_1 =
	     EN_specUpdate_incorrectSpeculation &&
	     (specUpdate_incorrectSpeculation_kill_all ||
	      sb__h9527[specUpdate_incorrectSpeculation_kill_tag]) ;
  assign MUX_m_m_valid_0_dummy2_0$write_1__SEL_2 =
	     EN_deq && p__h6524 == 1'd0 ;
  assign MUX_m_m_valid_1_dummy2_0$write_1__SEL_1 =
	     EN_deq && p__h6524 == 1'd1 ;
  assign MUX_m_m_valid_1_dummy2_0$write_1__SEL_2 =
	     EN_specUpdate_incorrectSpeculation &&
	     (specUpdate_incorrectSpeculation_kill_all ||
	      sb__h9705[specUpdate_incorrectSpeculation_kill_tag]) ;
  ...
  assign m_m_deqP_ehr_rl$D_IN =
	     m_m_deqP_ehr_lat_0$whas ? upd__h5403 : m_m_deqP_ehr_rl ;
  ...
  // register m_m_row_0
  assign m_m_row_0$D_IN = enq_x[91:4] ;
  assign m_m_row_0$EN = m_m_valid_0_lat_1$whas ;

  // register m_m_row_1
  assign m_m_row_1$D_IN = enq_x[91:4] ;
  ...
  assign NOT_SEL_ARR_NOT_m_m_row_0_4_BIT_18_05_06_NOT_m_ETC___d135 =
	     { !CASE_p524_0_NOT_m_m_row_0_BIT_18_1_NOT_m_m_row_ETC__q1,
	       CASE_p524_0_m_m_row_0_BITS_17_TO_11_1_m_m_row__ETC__q2,
	       CASE_p524_0_m_m_row_0_BIT_10_1_m_m_row_1_BIT_1_ETC__q3,
	       CASE_p524_0_m_m_row_0_BIT_9_1_m_m_row_1_BIT_9__ETC__q4,
	       CASE_p524_0_m_m_row_0_BITS_8_TO_5_1_m_m_row_1__ETC__q5,
	       CASE_p524_0_m_m_row_0_BITS_4_TO_0_1_m_m_row_1__ETC__q6 } ;
  ...
  assign sb__h9705 =
	     (m_m_specBits_1_dummy2_0$Q_OUT &&
	      m_m_specBits_1_dummy2_1$Q_OUT) ?
	       m_m_specBits_1_rl :
	       4'd0 ;
  assign upd__h3359 = sb__h10095 & specUpdate_correctSpeculation_mask ;
  assign upd__h4288 = sb__h10522 & specUpdate_correctSpeculation_mask ;
  assign upd__h5403 =
	     !m_m_deqP_ehr_dummy2_0$Q_OUT || !m_m_deqP_ehr_dummy2_1$Q_OUT ||
	     !m_m_deqP_ehr_rl ;
  assign x_snd_fst__h7135 = p__h6524 ;
  always@(p__h6524 or
	  m_m_valid_0_dummy2_0$Q_OUT or
	  m_m_valid_0_dummy2_1$Q_OUT or
	  m_m_valid_0_rl or
  ...
  always@(p__h6524 or m_m_row_0 or m_m_row_1)
  begin
    case (p__h6524)
      1'd0:
	  CASE_p524_0_NOT_m_m_row_0_BIT_18_1_NOT_m_m_row_ETC__q1 =
  ...
  always@(p__h6524 or sb__h9527 or sb__h9705)
  begin
    case (p__h6524)
      1'd0: CASE_p524_0_sb527_1_sb705_DONTCARE__q9 = sb__h9527;
      1'd1: CASE_p524_0_sb527_1_sb705_DONTCARE__q9 = sb__h9705;
    endcase
  end
  ...
  begin
    ...
    m_m_enqP = 1'h0;
    m_m_row_0 = 88'hAAAAAAAAAAAAAAAAAAAAAA;
    m_m_row_1 = 88'hAAAAAAAAAAAAAAAAAAAAAA;
