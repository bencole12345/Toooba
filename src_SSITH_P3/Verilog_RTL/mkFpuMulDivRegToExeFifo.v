...
module mkFpuMulDivRegToExeFifo(CLK,
  ...
  reg [20 : 0] CASE_enq_x_BITS_235_TO_233_0_enq_x_BITS_235_TO_ETC__q2,
	       CASE_m_m_row_0_BITS_231_TO_229_0_m_m_row_0_BIT_ETC__q4;
  reg [2 : 0] CASE_enq_x_BITS_218_TO_216_0_enq_x_BITS_218_TO_ETC__q1,
	      CASE_m_m_row_0_BITS_214_TO_212_0_m_m_row_0_BIT_ETC__q3;
  wire [3 : 0] IF_m_m_specBits_0_dummy2_0_read__1_AND_m_m_spe_ETC___d94,
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h8975 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN =
	     { CASE_enq_x_BITS_235_TO_233_0_enq_x_BITS_235_TO_ETC__q2,
	       enq_x[214:4] } ;
  ...
  begin
    case (enq_x[218:216])
	  ...
	  CASE_enq_x_BITS_218_TO_216_0_enq_x_BITS_218_TO_ETC__q1 =
	      enq_x[218:216];
      default: CASE_enq_x_BITS_218_TO_216_0_enq_x_BITS_218_TO_ETC__q1 = 3'd7;
    endcase
  end
  always@(enq_x or CASE_enq_x_BITS_218_TO_216_0_enq_x_BITS_218_TO_ETC__q1)
  begin
    case (enq_x[235:233])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_enq_x_BITS_235_TO_233_0_enq_x_BITS_235_TO_ETC__q2 =
	  ...
	  CASE_enq_x_BITS_235_TO_233_0_enq_x_BITS_235_TO_ETC__q2 =
		...
		CASE_enq_x_BITS_218_TO_216_0_enq_x_BITS_218_TO_ETC__q1,
		enq_x[215] };
      default: CASE_enq_x_BITS_235_TO_233_0_enq_x_BITS_235_TO_ETC__q2 =
		   21'd1485482;
    endcase
  end
  always@(m_m_row_0)
  begin
    case (m_m_row_0[214:212])
      3'd0, 3'd1, 3'd2, 3'd3, 3'd4:
	  CASE_m_m_row_0_BITS_214_TO_212_0_m_m_row_0_BIT_ETC__q3 =
	      m_m_row_0[214:212];
      default: CASE_m_m_row_0_BITS_214_TO_212_0_m_m_row_0_BIT_ETC__q3 = 3'd7;
    endcase
  end
  always@(m_m_row_0 or CASE_m_m_row_0_BITS_214_TO_212_0_m_m_row_0_BIT_ETC__q3)
  begin
    case (m_m_row_0[231:229])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_m_m_row_0_BITS_231_TO_229_0_m_m_row_0_BIT_ETC__q4 =
	      m_m_row_0[231:211];
      3'd4:
	  CASE_m_m_row_0_BITS_231_TO_229_0_m_m_row_0_BIT_ETC__q4 =
		...
		CASE_m_m_row_0_BITS_214_TO_212_0_m_m_row_0_BIT_ETC__q3,
		m_m_row_0[211] };
      default: CASE_m_m_row_0_BITS_231_TO_229_0_m_m_row_0_BIT_ETC__q4 =
		   21'd1485482;
    endcase
  end
