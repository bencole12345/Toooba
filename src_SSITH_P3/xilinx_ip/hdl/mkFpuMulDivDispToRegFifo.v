...
module mkFpuMulDivDispToRegFifo(CLK,
  ...
  reg [20 : 0] CASE_enq_x_BITS_67_TO_65_0_enq_x_BITS_67_TO_47_ETC__q2,
	       CASE_m_m_row_0_BITS_63_TO_61_0_m_m_row_0_BITS__ETC__q4;
  reg [2 : 0] CASE_enq_x_BITS_50_TO_48_0_enq_x_BITS_50_TO_48_ETC__q1,
	      CASE_m_m_row_0_BITS_46_TO_44_0_m_m_row_0_BITS__ETC__q3;
  wire [3 : 0] IF_m_m_specBits_0_dummy2_0_read__15_AND_m_m_sp_ETC___d118,
  ...
  assign m_m_specBits_0_lat_1$wget =
	     sb__h9361 & specUpdate_correctSpeculation_mask ;

  // register m_m_row_0
  assign m_m_row_0$D_IN =
	     { CASE_enq_x_BITS_67_TO_65_0_enq_x_BITS_67_TO_47_ETC__q2,
	       enq_x[46:4] } ;
  ...
  begin
    case (enq_x[50:48])
	  ...
	  CASE_enq_x_BITS_50_TO_48_0_enq_x_BITS_50_TO_48_ETC__q1 =
	      enq_x[50:48];
      default: CASE_enq_x_BITS_50_TO_48_0_enq_x_BITS_50_TO_48_ETC__q1 = 3'd7;
    endcase
  end
  always@(enq_x or CASE_enq_x_BITS_50_TO_48_0_enq_x_BITS_50_TO_48_ETC__q1)
  begin
    case (enq_x[67:65])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_enq_x_BITS_67_TO_65_0_enq_x_BITS_67_TO_47_ETC__q2 =
	  ...
	  CASE_enq_x_BITS_67_TO_65_0_enq_x_BITS_67_TO_47_ETC__q2 =
		...
		CASE_enq_x_BITS_50_TO_48_0_enq_x_BITS_50_TO_48_ETC__q1,
		enq_x[47] };
      default: CASE_enq_x_BITS_67_TO_65_0_enq_x_BITS_67_TO_47_ETC__q2 =
		   21'd1485482;
    endcase
  end
  always@(m_m_row_0)
  begin
    case (m_m_row_0[46:44])
      3'd0, 3'd1, 3'd2, 3'd3, 3'd4:
	  CASE_m_m_row_0_BITS_46_TO_44_0_m_m_row_0_BITS__ETC__q3 =
	      m_m_row_0[46:44];
      default: CASE_m_m_row_0_BITS_46_TO_44_0_m_m_row_0_BITS__ETC__q3 = 3'd7;
    endcase
  end
  always@(m_m_row_0 or CASE_m_m_row_0_BITS_46_TO_44_0_m_m_row_0_BITS__ETC__q3)
  begin
    case (m_m_row_0[63:61])
      3'd0, 3'd1, 3'd2, 3'd3:
	  CASE_m_m_row_0_BITS_63_TO_61_0_m_m_row_0_BITS__ETC__q4 =
	      m_m_row_0[63:43];
      3'd4:
	  CASE_m_m_row_0_BITS_63_TO_61_0_m_m_row_0_BITS__ETC__q4 =
		...
		CASE_m_m_row_0_BITS_46_TO_44_0_m_m_row_0_BITS__ETC__q3,
		m_m_row_0[43] };
      default: CASE_m_m_row_0_BITS_63_TO_61_0_m_m_row_0_BITS__ETC__q4 =
		   21'd1485482;
    endcase
  end
  ...
  initial
  begin
    m_m_row_0 = 64'hAAAAAAAAAAAAAAAA;
